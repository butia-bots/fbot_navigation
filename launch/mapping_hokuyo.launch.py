...
def generate_launch_description():
    config_dir = os.path.join(get_package_share_directory('fbot_navigation'), 'config')
    package_dir_navigation = get_package_share_directory('shark_description')
    ...
    robot_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(package_dir_navigation, 'launch', 'shark_description.launch.py')
